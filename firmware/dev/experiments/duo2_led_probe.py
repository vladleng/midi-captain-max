...
Tries up to 12 pixels (NANO4 count) to be safe.
DUO has 2 switches, expecting 6 LEDs (3 per switch).
"""
...
LED_PIN = board.GP7
MAX_TEST = 12  # Try up to this many

print("=" * 50)
print("DUO 2 NeoPixel Probe")
print("=" * 50)
