"""
ONE 1 Hardware Probe Script

Deploy as code.py on the ONE to discover switch pin mappings.
Connect via serial console (screen /dev/tty.usbmodem* 115200) and
press the footswitch. The script prints which GPIO pins changed state.

The ONE has 1 footswitch. From the OEM boot.py, GP11 is used as
a boot switch — likely the footswitch pin (same as DUO2's KEY0).

Based on the proven approach used for Mini6, NANO4, and DUO2 reverse engineering.
"""
...
print("=" * 50)
print("ONE 1 Pin Scanner")
print("=" * 50)
print()
print("Setting up all pins as INPUT with PULL_UP...")
print("Press the footswitch.")
