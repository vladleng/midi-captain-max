"""
DUO 2 Hardware Probe Script

Deploy as code.py on the DUO to discover switch pin mappings.
...
The DUO has 2 footswitches. From the OEM boot.py, GP11 is used as
a boot switch — this may or may not be a footswitch pin.

Based on the proven approach used for Mini6 and NANO4 reverse engineering.
"""
